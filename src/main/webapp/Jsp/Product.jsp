...
<div class="i_bg">
    ...
    <div class="content">
        ...
        <div id="tsShopContainer">
                                            <%--更换图片--%>
            <div id="tsImgS"><a href="../imgfiles/${listProduct[0].fileName}" title="../images" class="MagicZoom" id="MagicZoom"><img src="../imgfiles/${listProduct[0].fileName}" width="390" height="390" /></a></div>
        ...
        <div class="pro_des">
            <div class="des_name">
                <p>${listProduct[0].name}</p>
                “开业巨惠，北京专柜直供”，不光低价，“真”才靠谱！
            </div>
            <div class="des_price">
                本店价格：<b>￥${listProduct[0].price}</b><br />
                消费积分：<span>28R</span>
            </div>
