...
<head>
    ...
    <script type="text/javascript" src="/easyjs/MemberOn.js"></script>
...
<div class="soubg">
    <div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
        	<span class="fl">你好，<a href="Login.jsp">${loginName}</a>&nbsp; <a href="Regist.jsp" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="javascript:void(0)">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                    ...
                    <div class="ss_list_bg">
                        ...
                        <div class="ss_list_c">
                            <ul>
                                <li><a href="javascript:void(0)">我的收藏夹</a></li>
                                <li><a href="javascript:void(0)">我的收藏夹</a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <span class="s_sh"><a href="javascript:void(0)" class="sh1">新浪</a><a href="javascript:void(0)" class="sh2">微信</a></span>
            <span class="fr">|&nbsp;<a href="javascript:void(0)">手机版&nbsp;<img src="/images/s_tel.png" align="absmiddle" /></a></span>
        </span>
    </div>
</div>
<div class="m_top_bg">
    <div class="top">
        ...
        <div class="i_car">
            ...
            <div class="car_bg">
                ...
                <ul class="cars">
                    <li>
                        <div class="img"><a href="javascript:void(0)"><img src="/images/car1.jpg" width="58" height="58" /></a></div>
                        <div class="name"><a href="javascript:void(0)">法颂浪漫梦境50ML 香水女士持久清新淡香 送2ML小样3只</a></div>
                        <div class="price"><font color="#ff4e00">￥399</font> X1</div>
                    </li>
                    <li>
                        <div class="img"><a href="javascript:void(0)"><img src="/images/car2.jpg" width="58" height="58" /></a></div>
    ...
    <div class="m_content">
        <div class="m_left">
            ...
            <div class="left_m">
                ...
                <ul>
                    <li id="order"><a href="javascript:void(0)">我的订单</a></li>
                    <li id="address"><a href="javascript:void(0)" >收货地址</a></li>
                    <li><a href="javascript:void(0)">缺货登记</a></li>
                    <li><a href="javascript:void(0)">跟踪订单</a></li>
                </ul>
            </div>
            ...
            <div class="left_m">
                ...
                <ul>
                    <li id="user"><a href="javascript:void(0)">用户信息</a></li>
                    <li id="collect"><a href="javascript:void(0)">我的收藏</a></li>
                    <li id="msg"><a href="javascript:void(0)">我的留言</a></li>
                    <li id="links"><a href="javascript:void(0)">推广链接</a></li>
            ...
            <div class="left_m">
                ...
                <ul>
                    <li id="safe"><a href="javascript:void(0)">账户安全</a></li>
                    <li id="packet"><a href="javascript:void(0)">我的红包</a></li>
                    <li id="money"><a href="javascript:void(0)">资金管理</a></li>
                </ul>
            </div>
            <div class="left_m">
                <div class="left_m_t t_bg4">分销中心</div>
                <ul>
                    <li id="member"><a href="javascript:void(0)">我的会员</a></li>
                    <li id="result"><a href="javascript:void(0)">我的业绩</a></li>
                    <li id="commission"><a href="javascript:void(0)">我的佣金</a></li>
                    <li id="cash"><a href="javascript:void(0)">申请提现</a></li>
                </ul>
            </div>
        </div>
        <div class="m_right">
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            ...
                            <p>
                                ...
                                您还没有通过邮件认证 <a href="javascript:void(0)" style="color:#ff4e00;">点此发送认证邮件</a>
                            </p>
                            <div class="m_notice">
                                用户中心公告！
                            </div>
