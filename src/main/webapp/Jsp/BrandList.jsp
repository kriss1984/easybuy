    ...
    <div class="content mar_20">
        ...
        <div class="l_list">
            ...
            <div class="list_t">
                ...
                <span class="fr">共发现${fn:length(listBrand)}件</span>
                <%--45666666666666666666666666666666666666666666666666666666666666666666444444444444--%>
            </div>
            <div class="list_c">

                <ul class="cate_list">
                    <c:forEach items="${listBrand}" var="list" varStatus="indexs">
                    <li>
                        <div class="img"><a href="#"><img src="../imgfiles/${list.fileName}" width="210" height="185" /></a></div>
                        <div class="price">
