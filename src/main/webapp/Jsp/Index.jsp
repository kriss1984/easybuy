...
<head>
    ...
    <script type="text/javascript" src="/easyjs/sidebar.js"></script>
    <script type="text/javascript" src="/easyjs/indexjs.js"></script>
...
<div class="soubg">
    <div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
        	<span class="fl">你好，<a href="Login.jsp">请登录</a>&nbsp; <a href="Regist.jsp" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                    <a href="#">收藏夹</a>
...
<div class="i_bg bg_color">
    <div class="i_ban_bg">
        ...
        <div class="inews">
            ...
            <ul>
                <li><span>[ 特惠 ]</span><a href="#"></a></li>
                <li><span>[ 公告 ]</span><a href="#"></a></li>
                <li><span>[ 特惠 ]</span><a href="#"></a></li>
                <li><span>[ 公告 ]</span><a href="#"></a></li>
                <li><span>[ 公告 ]</span><a href="#"></a></li>
            </ul>
        ...
        <div class="fresh_mid">
            <ul>
                <li>
                    ...
                    <div class="price">
                        <font>￥<span>198.00</span></font> &nbsp; 26R<!-- 钱-->
                    </div>
